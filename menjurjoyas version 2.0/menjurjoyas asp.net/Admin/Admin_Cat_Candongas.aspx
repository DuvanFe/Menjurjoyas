...
<div id="wrapper">
    ...
    <div id="main">
    	...
    	<div id="right-part" class="style24">
        	<h1 class="style28">Candongas</h1>
            <table class="style59">
                <tr>
                    <td style="text-align: center">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Image ID="Image1" runat="server" Height="94px" 
                            ImageUrl="~/Admin/Imagenes/Joyas/Candongas.JPG" Width="109px" />
                    </td>
                </tr>
            </table>
            <p class="style31">
                ...
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            DataKeyNames="IDProducto" DataSourceID="SqlDataSource2" Width="958px">
                            <Columns>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                            ...
                            SelectCommand="SELECT * FROM [Producto] WHERE ([Referencia] = @Referencia)">
                            <SelectParameters>
                                <asp:Parameter DefaultValue="argollas" Name="Referencia" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </td>
                </tr>
