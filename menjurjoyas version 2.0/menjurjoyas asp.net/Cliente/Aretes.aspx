            ...
            <center>
                <table cellpadding="2" class="style28">
                    ...
                    <tr>
                        <td class="style62" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style97">&nbsp;</span><input id="Checkbox2" type="checkbox" 
                                class="style97" /><span class="style97">&nbsp;&nbsp;
                            </span>
                            <br class="style97" />
                            <span class="style97">$ 500.000</span></td>
                        <td class="style94" 
                            ...
                            <input id="Checkbox8" type="checkbox" class="style97" /><span class="style97">&nbsp;&nbsp;
                            </span>
                            <br class="style97" />
                            <span class="style97">&nbsp;&nbsp;&nbsp; $ 700.000&nbsp;&nbsp;&nbsp;&nbsp;
                            </span>
                            <br class="style97" />
                            <span class="style97">&nbsp;</span></td>
                        <td class="style91" 
                            
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <input id="Checkbox4" type="checkbox" class="style97" /><br class="style97" />
                            <span class="style97">$ 350.000</span></td>
                    </tr>
                    <tr>
...
&nbsp;<img alt="" class="style86" src="Imagenes/aretes%20pendientes.jpg" /><br class="style74" />
                    ...
                    <tr>
                        <td class="style76" 
                            ...
                            <span class="style74">$ 400.000</span><br />
                            </td>
                        <td class="style96" 
                            
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <input id="Checkbox6" type="checkbox" /><br />
                            <span class="style74">&nbsp;$ 700.000</td>
                        <td class="style80" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <input id="Checkbox7" type="checkbox" /><br />
                            <span class="style74">$ 800.000</span></td>
                    </tr>
                    <tr>
