<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cadenas.aspx.cs" Inherits="Default2" %>
                ...
                <table cellpadding="2" class="style28">
                    ...
                    <tr>
                        <td class="style88" style="background-color: #808080">
                            <span class="style82">
                            <br />
                            Cadena cartier en oro de 18k</span><br class="style84" />
                            <img alt="" class="style81" 
                                src="Imagenes/Cadenas/Cadena%20cartier%20en%20oro.jpg" /><br class="style84" />
                        </td>
                        <td class="style45">
                            <span class="style87">Cadena oro de 18k con martillado y rhodium</span><br 
                                class="style85" />
                            <br class="style85" />
                            <img alt="" class="style86" 
                                src="Imagenes/Cadenas/Cadena%20en%20oro%2018k%20martillada.jpg" /><br class="style85" />
                        </td>
                        <td class="style89" style="background-color: #808080">
                            <span class="style82">Cadena en plata bañada en oro con maritillado</span><br 
                                class="style84" />
                            <br class="style84" />
                            <img alt="" class="style81" 
                                
                                src="Imagenes/Cadenas/Cadena%20en%20plata%20bañada%20en%20oro%20martillada.jpg" /><br />
                        </td>
                    </tr>
                    <tr>
                        <td class="style62" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            &nbsp;&nbsp;
                            <span class="style74">$ 900.000</span></td>
                        <td class="style90" 
...
&nbsp;
                    ...
                    <tr>
                        <td class="style63" style="background-color: #808080">
                            <span class="style68"><span class="style85">Cadena en plata con&nbsp;
                            </span>
                            <br class="style85" />
                            <span class="style85">&nbsp;eslabones</span><br class="style85" />
                            </span>
                            <br class="style84" />
                            <img alt="" class="style81" 
                                src="Imagenes/Cadenas/Cadena%20eslabones%20en%20plata.jpg" /><br 
                                class="style84" />
                            <br class="style84" />
                        </td>
                        <td class="style91" style="background-color: #808080">
                            <span class="style68"><span class="style85">Cadena en oro de 18k tejido escalera</span><br 
                                class="style85" />
                            </span>
                            <br class="style84" />
                            <br class="style84" />
&nbsp;<img alt="" class="style81" src="Imagenes/Cadenas/cadena%20oro%20tejido%20escalera.jpg" /><br 
                                class="style84" />
                            <br class="style84" />
                        </td>
                        <td class="style79" style="background-color: #808080">
                            <span class="style68"><span class="style85">Cadena en plata tejido artesanal</span><br 
                                class="style85" />
                            </span>&nbsp;<br class="style84" />
                            <br class="style84" />
                            <img alt="" class="style81" 
                                src="Imagenes/Cadenas/Cadena%20plata%20tejido%20artesanal.JPG" />&nbsp;<br 
                                class="style84" />
                            <br class="style84" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style76" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 320.000</span></td>
                        <td class="style92" 
                            
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 750.000</span></td>
                        <td class="style80" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 400.000</span></td>
                    </tr>
                    <tr>
                        <td class="style64" colspan="3" 
                            ...
                            <span class="style99">
                            <br />
                            ¡¡ Registrate como cliente menjurjoyas <a href="Registro.aspx">AQUI</a></span></span><br 
                                class="style100" />
                            <span class="style100">y podras adquirir nuestro productos, descuentos </span>
                            <br class="style100" />
                            <span class="style98"><span class="style99">y promociones !!</span></span></strong></td>
                    </tr>
                </table>
