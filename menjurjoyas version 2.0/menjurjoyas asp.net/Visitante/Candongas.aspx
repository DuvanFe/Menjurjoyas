<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Candongas.aspx.cs" Inherits="_Default" %>
    ...
    <div id="main">
    	...
    	<div id="left-part" class="style78">
            ...
            <p>Usuario:<br>
               ...
               <input type="submit" vale "intro" style="o傼"></p>
        </div>
    	<div id="right-part" class="style29" style="border-color: #000000;">
            ...
            <center>
                <table cellpadding="2" class="style28">
                    ...
                    <tr>
                        <td class="style83" style="background-color: #808080">
                            <span class="style87">Candongas en oro de 18k con diamantado</span><br 
                                class="style84" />
                            <span class="style84">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span>
                            <br class="style84" />
                            <img alt="" class="style81" 
                                src="Imagenes/Candongas/Candongas%20con%20diamantado%20oro.jpg" /><br class="style84" />
                        </td>
                        <td class="style45">
                            <span class="style71"><span class="style85">
                            <br />
                            Candongas en plata de bolas</span><br class="style85" />
                            <br />
                            <br />
                            </span>
                            <img alt="" class="style86" 
                                src="Imagenes/Candongas/Candongas%20melcocha%20plata%20-%20copia.jpg" /><br />
                            <br class="style85" />
                        </td>
                        <td class="style72" style="background-color: #808080">
                            <span class="style82"><span class="style85">Candongas oro plata con diamantado y circon</span><br 
                                class="style85" />
                            </span>
                            <br class="style84" />
                            <img alt="" class="style81" 
                                src="Imagenes/Candongas/candongas%20oro-plata.jpg" /><br class="style84" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style62" 
...
&nbsp;
                    ...
                    <tr>
                        <td class="style63" style="background-color: #808080">
                            <span class="style82"><span class="style85">Candongas melcocha en plata</span><br class="style85" />
                            </span>
                            <br class="style84" />
                            <img alt="" class="style81" 
                                src="Imagenes/Candongas/Candongas%20melcocha%20plata.jpg" /><br class="style84" />
                        </td>
                        <td class="style79" style="background-color: #808080">
                            <span class="style82"><span class="style85">Candongas oro blanco con diamantes</span><br 
                                class="style85" />
                            </span>
                            <br class="style84" />
&nbsp;<img alt="" class="style81" 
                                src="Imagenes/Candongas/candongas%20oro%20blanco%20con%20diamantes.jpg" /><br 
                                class="style84" />
                        </td>
                        <td class="style79" style="background-color: #808080">
                            <span class="style82"><span class="style85">Candongas en plata diamantadas</span><br 
                                class="style85" />
                            </span>
                            <br class="style84" />
                            <img alt="" class="style81" 
                                src="Imagenes/Candongas/Candongas%20plata%20con%20diamantado.jpg" />&nbsp;<br 
                                class="style84" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style76" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 150.000    </td>
                        <td class="style80" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 1.100.000</span></td>
                        <td class="style80" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 180.000</span></td>
                    </tr>
                    <tr>
