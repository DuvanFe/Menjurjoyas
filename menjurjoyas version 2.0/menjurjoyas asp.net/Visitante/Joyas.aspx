<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Joyas.aspx.cs" Inherits="Default3" %>
...
<div id="wrapper">
    ...
    <div id="main">
		<div class="ic"></div>
    	<div id="left-part" class="stile categoria">
        	<h1>Categoria</h1>
            <ul id="subnavi">
                ...
                <table cellpadding="2" class="style28">
                    <tr>
                        ...
                        <td class="style49" colspan="3" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <strong>Joyas</strong></td>
                        <td rowspan="6" 
                            
                            
                            style="background-color: #0C0C0C; background-image: url('../Imagenes/rojo.jpg');" 
                            class="style60">
                        </td>
                    </tr>
                    <tr>
                        <td class="style84" style="background-color: #808080">
                            <span class="style87"><a href="Anillos.aspx"><span class="style71">Anillos</span></a></span><br 
                                class="style74" />
                            <span class="style74">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span>
                            <br class="style74" />
                        ...
                        <td class="style45">
                            <span class="style85">
                            <span class="style87"><a href="Aretes.aspx"><span class="style71">Aretes</span></a></span></span><span class="style91"></span></a><br 
                            class="style71" />
                            <br class="style71" />
                        ...
                        <td class="style95" style="background-color: #808080">
                            <span class="style85">
                            <span class="style87"><a href="Argollas.aspx"><span class="style71">Argollas</span></a></span></span><br class="style87" />
                            <br class="style87" />
                    ...
                    <tr>
                        <td class="style63" style="background-color: #808080">
                            <span class="style87"><a href="Cadenas.aspx"><span class="style71">Cadenas</span></a>
                            <br />
                            </span>
                            <br class="style87" />
                        ...
                        <td class="style79" style="background-color: #808080">
                            <span class="style86"><a href="Candongas.aspx"><span class="style71">Candongas</span></a></span>
                            <br class="style87" />
                            <br class="style87" />
&nbsp;<img alt="" class="style90" src="Imagenes/Joyas/Candongas.JPG" /><br class="style87" />
                            <br class="style87" />
                        </td>
                        <td class="style101" style="background-color: #808080">
                            <span class="style86"><a href="Dijes.aspx"><span class="style71">Dijes</span></a><br />
                            </span>
                            <br class="style87" />
                    ...
                    <tr>
                        <td class="style92" 
                            ...
                            <span class="style86"><a href="Pulseras.aspx"><span class="style71">Pulseras</span></a></span><br />
                            <br />
