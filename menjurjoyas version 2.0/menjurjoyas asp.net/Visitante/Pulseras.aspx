<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pulseras.aspx.cs" Inherits="_Default" %>
                ...
                <table cellpadding="2" class="style28">
                    ...
                    <tr>
                        <td class="style84" style="background-color: #808080">
                            <span class="style83">Esclava en plata para hombre<br />
                            </span><span class="style85">&nbsp;</span><br class="style85" />
                            <img alt="" class="style86" 
                                src="Imagenes/Pulseras/Esclava%20para%20hombre%20en%20plata.jpg" /><br 
                                class="style85" />
                            <br class="style85" />
                        </td>
                        <td class="style45">
                            <span class="style71">Pulsera brazalete para mujer en plata con simbolos</span><br class="style81" />
                            <br class="style81" />
                            <img alt="" class="style82" 
                                src="Imagenes/Pulseras/Pulsera%20brazalete%20para%20mujer.jpg" /><br />
                            <br class="style81" />
                        </td>
                        <td class="style87" style="background-color: #808080">
                            <span class="style83">Pulsera de eslabones en oro de 18k<br />
                            <br />
                            </span>
                            <img alt="" class="style86" 
                                src="Imagenes/Pulseras/Pulsera%20en%20oro%20de%20eslabones.jpg" /><br />
                            <br class="style85" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style62" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 100.000</span></td>
                        <td class="style72" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <br />
&nbsp;
                    ...
                    <tr>
                        <td class="style63" style="background-color: #808080">
                            <span class="style68"><span class="style81">Pulsera de eslabones en plata
                            </span>
                            <br class="style81" />
                            <br class="style81" />
                            </span>
                            <img alt="" class="style86" 
                                src="Imagenes/Pulseras/Pulsera%20eslabones%20plata.jpg" /><br class="style85" />
                        </td>
                        <td class="style79" style="background-color: #808080">
                            <span class="style83">Pulsera oro blanco con diamantes<br />
                            </span>
                            <br class="style85" />
&nbsp;<img alt="" class="style86" src="Imagenes/Pulseras/Pulsera%20oro%20blanco%20con%20diamantes.jpg" /><br class="style85" />
                        </td>
                        <td class="style79" style="background-color: #808080">
                            <span class="style68"><span class="style81">Pulsera tejido artesanal en plata</span><br 
                                class="style81" />
                            </span>&nbsp;<br class="style85" />
                            <img alt="" class="style86" 
                                src="Imagenes/Pulseras/Pulsera%20tejido%20artesanal%20en%20plata.jpg" />&nbsp;<br class="style85" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style76" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 120.000</span></td>
                        <td class="style80" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 570.000</span></td>
                        <td class="style80" 
                            style="background-color: #808080; background-image: url('Imagenes/rojo.jpg');">
                            <span class="style74">$ 120.000</span></td>
                    </tr>
